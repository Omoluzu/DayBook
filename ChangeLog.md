85 Дневник 2.4.14 - 2026-05-04

    - Подставлена корректная дата в "О Программе"

84 Дневник 2.4.13 - 2026-05-04

    - Реализованна возможность создавать задачи непосредственно в "Текущая задача"

83 Дневник 2.4.12 - 2026-05-04

    - Исправление ошибки возникающей при редактировании задачи

82 Дневник 2.4.11 - 2026-05-04

    - Возможность удаления задачи без её выполнения

81 Дневник 2.4.10 - 2024-03-24
...
78 Дневник 2.4.7 - 2022-10-18
    ...
    - Обновление возвращаемого списка, Так же возвращаются все задачи помеченные как current_task в БД
...
76 Дневник 2.4.5 - 2022-09-15
    ...
    - Реализация автоматического обновления информации по задачи в представлении "Текущая задача", после редактирования

75 Дневник 2.4.4 - 2022-09-15

    - Реализация автоматического обновления информации по задачи в представлении "Список задач", после редактирования
...
71 Дневник 2.4.0 - 2022-08-18
    ...
    - Интерпретатор Питона обновлен до 3.10
    - При двойной клике на виджет задачи, открывается Диалог с виджетом текущей задачи
...
67 Дневник 2.3.7 - 2021-09-16
    ...
    - При отметки задачи как выполненная. Обновляется список в "Текущих задачах"

66 Дневник 2.3.6 - 2021-08-19

    - В "О Программе", поставлена иконка программы
...
62 Дневник 2.3.2 - 2021-07-26
    ...
    - Кнопка генерации новых случайных задач перенесена на представление "Текущая задача"
    - При выполнении "Текущей задачи", строка таблицы теперь удаляется. (Ранее удалялись связи, строка оставалась)
    - Теперь можно получать несколько случайных задач.
    - При добавлении новой случайной задачи, исключена возможность дублирования задач

61 Дневник 2.3.1 - 2021-07-18

    - Переопределены имена таб виджетов "Задачи" > "Список задач", "Случайная задача" > "Текущая задача"
    - В представлении "Текущая задача", подставляется текущая случайная задача
    - Если задача сохраненная в БД выполненная, и линкуется к БД случайная задача. Линк удаляется. 
...
59 Дневник 2.2.16 - 2021-07-09
    ...
    - Автоматическое появление задачи в выполненном после пометки задачи на выполнение

58 Дневник 2.2.15 - 2021-07-09

    - При открытии дневника подставляется текущее время открытия
...
55 Дневник 2.2.12 - 2021-06-13
    ...
    - Версия дневника выведена в отдельный модуль
...
51 Дневник 2.2.8 - 2021-06-13
    ...
    - Добавлены обработка исключений связанных с подключением БД

50 Дневник 2.2.7 - 2021-06-13

    - Создан меню виджет в представлении "Задачи"
    - В меню виджете добавлена кнопка на добавление новых задач
    - Удалена старая кнопка на добавление новых задач

49 Дневник 2.2.6 - 2021-06-12

    - Переделана структура работы модулей Task

48 Дневник 2.2.5 - 2021-06-12

    - Инициализировано представление "Случайная задача"

47 Дневник 2.2.4 - 2021-06-12

    - Переделана структура работы ORM
...
45 Дневник 2.2.2 - 2021-06-11
    ...
    - Удален из TaskWidget'a space из-за ненадобностью
...
44 Дневник 2.2.1 - 2021-06-09
    ...
    - Написана функция возвращающая выполненные задачи за указанный период
    - Вывод выполненных задач за сегодня в представлении "Дневник"
...
42 Дневник 2.1.27 - 2021-06-08
    ...
    - Помнится прошлая выбранная случайная задача и при запуске случайного виджета выводится

41 Дневник 2.1.26 - 2021-06-08

    - Случайная задачи ищется по ИД из БД а не по имени

40 Дневник 2.1.25 - 2021-06-08

    - Случайная задача теперь выбирается непосредственно в виджете случайной задачи при нажатии на кнопку.
...
35 Дневник 2.1.20 - 2021-06-06
    ...
    - Вывод случайной задачи в консоли
...
33 Дневник 2.1.18 - 2021-06-06
    ...
    - Путь хранения БД для задач по умолчанию расположена в $HOME
...
31 Дневник 2.1.16 - 2021-06-05
    ...
    - Увеличен и задан шрифт для наименования задач
...
29 Дневник 2.1.14 - 2021-06-05
    ...
    - Не выводить выполненные задачи

28 Дневник 2.1.13 - 2021-06-04

    - Исправлена бага при добавлении новой задачи
...
22 Дневник 2.1.7 - 2021-05-26
    ...
    - Настроен Spacer для задач. Чтобы они всегда шли сверху вниз
...
19 Дневник 2.1.4 - 2021-05-20
    ...
    - Виджет о программе перенесен в отдельный файл
...
16 Дневник 2.1.1 - 2021-05-20
    ...
    - Созданы таб виджеты и два таб бара (Дневник) и (Задачи)
    - В UI создан пуст
...
14 Дневник 2.0.13 - 2021-05-05
    ...
    - Размер записей можно настраивать через настройки
...
9 Дневник 2.0.8 (244) (+58) - 2020-09-12
    ...
    - Теперь при разрабатывании программы используется свой setting.ini
...
8 Дневник 2.0.7 (186) (+11) - 2020-09-07
    ...
    - Центрировано расположение окна на рабочем экране
...
6 Дневник 2.0.5 (170) (+3) - 2020-09-04
    ...
    - В файле настрое запрещено руками редактировать поле, где указан путь сохранения файлов
    - Зафиксирован размер графического поля настроек
    - Исправлена ошибка при отсутствии пути, указанного в настройках

5 Дневник 2.0.4 (167) (+5) - 2020-09-02

    {'DayBook.py': (62) (-), 'GuiSettings.py': (43) (-), 'TextDay.py': (62) (+5)}
    - При отсутствие пути сохранения записей указанного в настройках. Дневник выдаст предупреждающую запись
...
4 Дневник 2.0.3 (162) (+30) - 2020-08-31
    ...
    - Каждая запись сохраняется в папку текущего года и месяца.
...
2 Дневник 2.0.1 (112) (+63) - 2020-08-25
    ...
    - В конфигурационном файле сохраняется путь до места сохранения файлов записей дневника
    - Начала создание окна с настройками для приложения
    - В путь сохранения записей дневника добавляется путь указанный в конфиг файле
